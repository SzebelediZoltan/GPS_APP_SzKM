...
} from "./chunk-LAKMCAQM.js";
import {
  useIsHydrated
} from "./chunk-25UTK6UI.js";
import {
  Anchor,
  Anchor2,
  Arrow,
  ...
  useSize
} from "./chunk-FVXD6O3Q.js";
import {
  createCollection,
  createCollection2,
  dist_exports as dist_exports3,
  useDirection
} from "./chunk-DLNT5SFL.js";
import {
  Branch,
  Combination_default,
  DismissableLayer,
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime7.jsx)(
      CheckboxProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
          ...
          isFormControl2 && (0, import_jsx_runtime7.jsx)(
            CheckboxBubbleInput,
            {
              __scopeCheckbox
            }
...
var NAME4 = "Label";
var Label3 = React10.forwardRef((props, forwardedRef) => {
...
var Form = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const [validityMap, setValidityMap] = React11.useState({});
    const getFieldValidity = React11.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React11.useCallback(
    ...
    const handleFieldValiditionClear = React11.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React11.useState({});
    const getFieldCustomMatcherEntries = React11.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React11.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React11.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React11.useState({});
    const getFieldCustomErrors = React11.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React11.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React11.useState({});
    const handleFieldMessageIdAdd = React11.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React11.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React11.useCallback(
...
var FormField = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const id = useId();
    return (0, import_jsx_runtime10.jsx)(FormFieldProvider, { scope: __scopeForm, id, name, serverInvalid, children: (0, import_jsx_runtime10.jsx)(
      Primitive.div,
      {
...
var FormControl = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React11.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React11.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    if (match === void 0) {
      return (0, import_jsx_runtime10.jsx)(FormMessageImpl, { ...messageProps, ref: forwardedRef, name, children: props.children || DEFAULT_INVALID_MESSAGE });
    } else if (typeof match === "function") {
      return (0, import_jsx_runtime10.jsx)(FormCustomMessage, { match, ...messageProps, ref: forwardedRef, name });
    } else {
      return (0, import_jsx_runtime10.jsx)(FormBuiltInMessage, { match, ...messageProps, ref: forwardedRef, name });
    }
  }
);
FormMessage.displayName = MESSAGE_NAME;
var FormBuiltInMessage = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    if (matches) {
      return (0, import_jsx_runtime10.jsx)(FormMessageImpl, { ref: forwardedRef, ...messageProps, name, children: children ?? DEFAULT_BUILT_IN_MESSAGES[match] });
    }
    return null;
  }
);
var FormCustomMessage = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React11.useMemo(() => ({ id, match }), [id, match]);
    ...
    if (matches) {
      return (0, import_jsx_runtime10.jsx)(FormMessageImpl, { id, ref: composedRef, ...messageProps, name, children: children ?? DEFAULT_INVALID_MESSAGE });
    }
    return null;
  }
);
var FormMessageImpl = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime10.jsx)(Primitive.span, { id, ...messageProps, ref: forwardedRef });
  }
);
...
var FormValidityState = (props) => {
  ...
  const name = nameProp ?? fieldContext.name;
  const validity = validationContext.getFieldValidity(name);
  return (0, import_jsx_runtime10.jsx)(import_jsx_runtime10.Fragment, { children: children(validity) });
};
FormValidityState.displayName = VALIDITY_STATE_NAME;
var SUBMIT_NAME = "FormSubmit";
var FormSubmit = React11.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, ...submitProps } = props;
    return (0, import_jsx_runtime10.jsx)(Primitive.button, { type: "submit", ...submitProps, ref: forwardedRef });
  }
);
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React12.useRef(false);
  const isPointerDownOnContentRef = React12.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React12.useCallback(() => setOpen(false), [setOpen]);
  React12.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
  ...
  return (0, import_jsx_runtime11.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime11.jsx)(Root22, { ...popperScope, children })
    }
  );
};
HoverCard.displayName = HOVERCARD_NAME;
var TRIGGER_NAME4 = "HoverCardTrigger";
var HoverCardTrigger = React12.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(PortalProvider, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime11.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime11.jsx)(Portal, { asChild: true, container, children }) }) });
};
HoverCardPortal.displayName = PORTAL_NAME3;
var CONTENT_NAME3 = "HoverCardContent";
var HoverCardContent = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime11.jsx)(
...
var HoverCardContentImpl = React12.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
  ...
  const [containSelection, setContainSelection] = React12.useState(false);
  React12.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React12.forwardRef(
  (props, forwardedRef) => {
...
var NAME5 = "Label";
var Label5 = React13.forwardRef((props, forwardedRef) => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(
      MenubarContextProvider,
      {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime13.jsx)(Collection.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime13.jsx)(Collection.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime13.jsx)(
          Root4,
          {
            asChild: true,
...
var MenubarTrigger = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(Collection.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime13.jsx)(
      Item,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var NavigationMenuProvider = (props) => {
  ...
  return (0, import_jsx_runtime14.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      children: (0, import_jsx_runtime14.jsx)(Collection2.Provider, { scope, children: (0, import_jsx_runtime14.jsx)(ViewportContentProvider, { scope, items: viewportContent, children }) })
    }
  );
};
...
var NavigationMenuList = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime14.jsx)(Primitive.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime14.jsx)(Collection2.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime14.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
...
var NavigationMenuTrigger = React15.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
    (0, import_jsx_runtime14.jsx)(Collection2.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: (0, import_jsx_runtime14.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime14.jsx)(
      Primitive.button,
      {
        id: triggerId,
        disabled,
  ...
  function OneTimePasswordFieldImpl({
    ...
    return (0, import_jsx_runtime15.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime15.jsx)(Collection3.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime15.jsx)(Collection3.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime15.jsx)(
          Root4,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldInput = React16.forwardRef(function OneTimePasswordFieldInput2({
  ...
  return (0, import_jsx_runtime15.jsx)(Collection3.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime15.jsx)(
    Item,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
var Slottable3 = createSlottable2("Slottable");
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React19.useState(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
...
var PopoverAnchor = React19.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger = React19.forwardRef(
  (props, forwardedRef) => {
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime18.jsx)(PortalProvider2, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime18.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime18.jsx)(Portal, { asChild: true, container, children }) }) });
};
PopoverPortal.displayName = PORTAL_NAME5;
var CONTENT_NAME6 = "PopoverContent";
var PopoverContent = React19.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext2(CONTENT_NAME6, props.__scopePopover);
    const { forceMount = portalContext.forceMount, ...contentProps } = props;
...
var Slot3 = createSlot2("PopoverContent.RemoveScroll");
var PopoverContentModal = React19.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME6, props.__scopePopover);
    const contentRef = React19.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React19.useRef(false);
    React19.useEffect(() => {
      const content = contentRef.current;
      if (content) return hideOthers(content);
    }, []);
    return (0, import_jsx_runtime18.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, children: (0, import_jsx_runtime18.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContentNonModal = React19.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME6, props.__scopePopover);
...
var PopoverContentImpl = React19.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React19.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React19.forwardRef(
  (props, forwardedRef) => {
...
var Radio = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React21.useState(null);
...
var RadioGroupItem = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const context = useRadioGroupContext(ITEM_NAME4, __scopeRadioGroup);
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React25.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime23.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React25.isValidElement(newElement) ? React25.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Slottable4 = createSlottable3("Slottable");
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime24.jsx)(Root22, { ...popperScope, children: (0, import_jsx_runtime24.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime24.jsx)(Collection4.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime24.jsx)(
        ...
        isFormControl2 ? (0, import_jsx_runtime24.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
            ...
            form,
            children: [
              value === void 0 ? (0, import_jsx_runtime24.jsx)("option", { value: "" }) : null,
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(
      Primitive.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? (0, import_jsx_runtime24.jsx)(import_jsx_runtime24.Fragment, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME6 = "SelectPortal";
var SelectPortal = (props) => {
  return (0, import_jsx_runtime24.jsx)(Portal, { asChild: true, ...props });
};
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM2.createPortal(
        (0, import_jsx_runtime24.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime24.jsx)(Collection4.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime24.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime24.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
...
var Slot5 = createSlot3("SelectContent.RemoveScroll");
var SelectContentImpl = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst3 = React26.useCallback(
      (candidates) => {
    ...
    const handleItemLeave = React26.useCallback(() => content?.focus(), [content]);
    ...
    return (0, import_jsx_runtime24.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime24.jsx)(Combination_default, { as: Slot5, allowPinchZoom: true, children: (0, import_jsx_runtime24.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [
      ...
      (0, import_jsx_runtime24.jsx)(Collection4.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime24.jsx)(
        Primitive.div,
        {
...
var SelectGroup = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime24.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime24.jsx)(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    const nativeOption = React26.useMemo(
      () => (0, import_jsx_runtime24.jsx)("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [
      (0, import_jsx_runtime24.jsx)(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime24.jsx)(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectScrollUpButton = React26.forwardRef((props, forwardedRef) => {
  ...
  return canScrollUp ? (0, import_jsx_runtime24.jsx)(
...
var SelectScrollDownButton = React26.forwardRef((props, forwardedRef) => {
  ...
  return canScrollDown ? (0, import_jsx_runtime24.jsx)(
    SelectScrollButtonImpl,
    {
      ...props,
      ref: composedRefs,
...
var SelectSeparator = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
var SelectArrow = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime24.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
...
var Separator4 = React27.forwardRef((props, forwardedRef) => {
...
var Slider = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React28.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React28.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React28.useRef(values);
...
var SliderHorizontal = React28.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React28.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React28.useRef(void 0);
    const direction = useDirection(dir);
...
var SliderVertical = React28.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const sliderRef = React28.useRef(null);
...
var SliderTrack = React28.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React28.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React28.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection5(props.__scopeSlider);
    const [thumb, setThumb] = React28.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React28.useMemo(
...
var SliderThumbImpl = React28.forwardRef(
  (props, forwardedRef) => {
...
var SliderBubbleInput = React28.forwardRef(
...
__export(dist_exports32, {
  Root: () => Slot6,
  Slot: () => Slot6,
  Slottable: () => Slottable5,
  createSlot: () => createSlot4,
  createSlottable: () => createSlottable4
});
var React29 = __toESM(require_react(), 1);
var import_jsx_runtime27 = __toESM(require_jsx_runtime(), 1);
function createSlot4(ownerName) {
  const SlotClone = createSlotClone4(ownerName);
  const Slot22 = React29.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime27.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React29.isValidElement(newElement) ? React29.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime27.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot22.displayName = `${ownerName}.Slot`;
  return Slot22;
}
...
function createSlottable4(ownerName) {
  const Slottable22 = ({ children }) => {
    return (0, import_jsx_runtime27.jsx)(import_jsx_runtime27.Fragment, { children });
  };
  Slottable22.displayName = `${ownerName}.Slottable`;
  Slottable22.__radixId = SLOTTABLE_IDENTIFIER4;
  return Slottable22;
}
var Slottable5 = createSlottable4("Slottable");
function isSlottable4(child) {
  return React29.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var Switch = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime28.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
...
var TabsContent = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime29.jsx)(
      Primitive.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
...
var ToastProvider = (props) => {
  ...
  return (0, import_jsx_runtime30.jsx)(Collection6.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime30.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime30.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime30.jsx)(Collection6.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime30.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime30.jsx)(
            FocusProxy,
            {
...
var Toast = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime30.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime30.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime30.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM3.createPortal(
        (0, import_jsx_runtime30.jsx)(Collection6.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime30.jsx)(
          Root2,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime30.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime30.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsx)(Primitive.div, { ...titleProps, ref: forwardedRef });
  }
);
...
var ToastDescription = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsx)(Primitive.div, { ...descriptionProps, ref: forwardedRef });
  }
);
...
var ToastAction = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime30.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
...
var ToastClose = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime30.jsx)(
      Primitive.button,
      {
        type: "button",
        ...closeProps,
...
var ToggleGroup = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime32.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime32.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime32.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime32.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime32.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime32.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime32.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime32.jsx)(
      Root4,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime32.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime32.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime32.jsx)(
      Item,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime32.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime32.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
var Separator5 = React35.forwardRef((props, forwardedRef) => {
...
var Toolbar = React36.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarSeparator = React36.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React36.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime34.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime34.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React36.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime34.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime34.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React36.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React36.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime34.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime34.jsx)(Item24, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
ToolbarToggleItem.displayName = TOGGLE_ITEM_NAME;
var Root42 = Toolbar;
var Separator6 = ToolbarSeparator;
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React37.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime35.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React37.isValidElement(newElement) ? React37.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React37.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
var TRIGGER_NAME10 = "TooltipTrigger";
var TooltipTrigger = React38.forwardRef(
  (props, forwardedRef) => {
    const { __scopeTooltip, ...triggerProps } = props;
    const context = useTooltipContext(TRIGGER_NAME10, __scopeTooltip);
    const providerContext = useTooltipProviderContext(TRIGGER_NAME10, __scopeTooltip);
    const popperScope = usePopperScope4(__scopeTooltip);
...
TooltipTrigger.displayName = TRIGGER_NAME10;
...
var TooltipContent = React38.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext3(CONTENT_NAME9, props.__scopeTooltip);
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime36.jsxs)(
          Content2,
          {
            ...
            children: [
              (0, import_jsx_runtime36.jsx)(Slottable7, { children }),
              (0, import_jsx_runtime36.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime36.jsx)(Root5, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
export {
  ...
  dist_exports5 as Collapsible,
  dist_exports13 as ContextMenu,
  dist_exports2 as Dialog,
  dist_exports3 as Direction,
  dist_exports4 as DropdownMenu,
  dist_exports15 as Form,
  dist_exports16 as HoverCard,
  dist_exports18 as Label,
  dist_exports19 as Menubar,
  dist_exports21 as NavigationMenu,
  dist_exports25 as Popover,
  dist_exports as Portal,
  dist_exports26 as Progress,
  dist_exports27 as RadioGroup,
  dist_exports28 as ScrollArea,
  dist_exports29 as Select,
  dist_exports30 as Separator,
  dist_exports31 as Slider,
  dist_exports32 as Slot,
  ...
  dist_exports7 as VisuallyHidden,
  dist_exports22 as unstable_OneTimePasswordField,
  dist_exports24 as unstable_PasswordToggleField
};
