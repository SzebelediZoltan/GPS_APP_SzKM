// node_modules/leaflet-rotate/src/dom/DomUtil.js
var domUtilProto = L.extend({}, L.DomUtil);
L.extend(L.DomUtil, {
  /**
  ...
  setTransform: function(el, offset, scale, bearing, pivot) {
    ...
    el.style[L.DomUtil.TRANSFORM] = "translate3d(" + pos.x + "px," + pos.y + "px,0)" + (scale ? " scale(" + scale + ")" : "") + " rotate(" + bearing + "rad)";
  },
  /**
...
// node_modules/leaflet-rotate/src/dom/Draggable.js
L.Draggable.include({
  /** @TODO */
...
// node_modules/leaflet-rotate/src/geometry/Point.js
...
// node_modules/leaflet-rotate/src/layer/DivOverlay.js
var divOverlayProto = L.extend({}, L.DivOverlay.prototype);
...
// node_modules/leaflet-rotate/src/layer/Popup.js
var popupProto = L.extend({}, L.Popup.prototype);
L.Popup.include({
  /**
...
// node_modules/leaflet-rotate/src/layer/Tooltip.js
var tooltipProto = L.extend({}, L.Tooltip.prototype);
L.Tooltip.include({
  _animateZoom: function(e) {
...
// node_modules/leaflet-rotate/src/layer/marker/Icon.js
var iconProto = L.extend({}, L.Icon.prototype);
L.Icon.include({
...
// node_modules/leaflet-rotate/src/layer/marker/Marker.js
var markerProto = L.extend({}, L.Marker.prototype);
...
// node_modules/leaflet-rotate/src/layer/tile/GridLayer.js
var gridLayerProto = L.extend({}, L.GridLayer.prototype);
L.GridLayer.include({
  /**
...
// node_modules/leaflet-rotate/src/layer/vector/Renderer.js
var rendererProto = L.extend({}, L.Renderer.prototype);
L.Renderer.include({
  /**
  ...
  _updateTransform: function(center, zoom) {
    ...
    var scale = this._map.getZoomScale(zoom, this._zoom), offset = this._map._latLngToNewLayerPoint(this._topLeft, zoom, center);
...
// node_modules/leaflet-rotate/src/map/Map.js
...
L.Map.include({
  ...
  containerPointToLayerPoint: function(point) {
    ...
    return L.point(point).subtract(this._getMapPanePos()).rotateFrom(-this._bearing, this._getRotatePanePos()).subtract(this._getRotatePanePos());
  },
  /**
  ...
  layerPointToContainerPoint: function(point) {
    ...
    return L.point(point).add(this._getRotatePanePos()).rotateFrom(this._bearing, this._getRotatePanePos()).add(this._getMapPanePos());
  },
  /**
  ...
  setBearing: function(theta) {
    ...
    var bearing = L.Util.wrapNum(theta, [0, 360]) * L.DomUtil.DEG_TO_RAD, center = this._getPixelCenter(), oldPos = this._getRotatePanePos().rotateFrom(-this._bearing, center), newPos = oldPos.rotateFrom(bearing, center);
  ...
  getBoundsZoom(bounds, inside, padding) {
    ...
    const min = this.getMinZoom(), max = this.getMaxZoom(), size = this.getSize().subtract(padding), boundsSize = this.mapBoundsToContainerBounds(bounds).getSize(), snap = this.options.zoomSnap, scalex = size.x / boundsSize.x, scaley = size.y / boundsSize.y, scale = inside ? Math.max(scalex, scaley) : Math.min(scalex, scaley);
  ...
  _getNewPixelOrigin: function(center, zoom) {
    ...
    return this.project(center, zoom).rotate(this._bearing)._subtract(viewHalf)._add(this._getMapPanePos())._add(this._getRotatePanePos()).rotate(-this._bearing)._round();
  },
  /**
   * @since leaflet-rotate (v0.2)
   * 
  ...
  _getNewPixelBounds: function(center, zoom) {
    ...
    var mapZoom = this._animatingZoom ? Math.max(this._animateToZoom, this.getZoom()) : this.getZoom(), scale = this.getZoomScale(mapZoom, zoom), pixelCenter = this.project(center, zoom).floor(), size = this.getSize(), halfSize = new L.Bounds([
...
// node_modules/leaflet-rotate/src/map/handler/ContainerMutation.js
L.Map.mergeOptions({
  /**
...
// node_modules/leaflet-rotate/src/map/handler/TouchGestures.js
L.Map.mergeOptions({
  /**
...
L.Map.TouchGestures = L.Handler.extend({
  ...
  _onTouchMove: function(e) {
    ...
    var map = this._map, p1 = map.mouseEventToContainerPoint(e.touches[0]), p2 = map.mouseEventToContainerPoint(e.touches[1]), vector = p1.subtract(p2), scale = p1.distanceTo(p2) / this._startDist, delta;
    if (this._rotating) {
    ...
    var moveFn = map._move.bind(map, this._center, this._zoom, { pinch: true, round: false }, void 0);
...
// node_modules/leaflet-rotate/src/map/handler/TouchRotate.js
L.Map.mergeOptions({
  /**
...
// node_modules/leaflet-rotate/src/map/handler/ShiftKeyRotate.js
L.Map.mergeOptions({
  /**
...
// node_modules/leaflet-rotate/src/map/handler/TouchZoom.js
L.Map.mergeOptions({
  /**
...
// node_modules/leaflet-rotate/src/control/Rotate.js
