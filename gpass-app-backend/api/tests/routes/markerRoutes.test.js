...
describe("API Marker Tesztek", () => 
{
    describe("/api/markers", () => 
    {
        ...
        describe("GET", () => 
        {
            ...
            {
                const res = await withAuth(request(app).get("/api/markers"));
        ...
        describe("POST", () => 
        {
            ...
            {
                const res = await withAuth(request(app).post("/api/markers"))
                .send({ creator_id: 1, marker_type: "poi", lat: 47.5, lng: 19.0 });
    ...
    describe("/api/markers/box", () => 
    {
        ...
        describe("GET", () => 
        {
            ...
            {
                const res = await withAuth(request(app).get("/api/markers/box?minLat=47&maxLat=48&minLng=19&maxLng=20"));
                expect(res.status).toBe(200);
                expect(Array.isArray(res.body)).toBe(true);
            });
        });
    ...
    describe("/api/markers/type/:markerType", () => 
    {
        ...
        describe("GET", () => 
        {
            ...
            {
                const res = await withAuth(request(app).get("/api/markers/type/poi"));
                expect(res.status).toBe(200);
                expect(Array.isArray(res.body)).toBe(true);
            });
        });
    ...
    describe("/api/markers/creator/:userId", () => 
    {
        ...
        describe("GET", () => 
        {
            ...
            {
                const res = await withAuth(request(app).get("/api/markers/creator/1"));
                expect(res.status).toBe(200);
                expect(Array.isArray(res.body)).toBe(true);
            });
        });
    ...
    describe("/api/markers/:markerID", () => 
    {
        ...
        describe("GET", () => 
        {
            ...
            {
                const res = await withAuth(request(app).get("/api/markers/1"));
                expect(res.status).toBe(200);
        ...
        describe("PUT", () => 
        {
            ...
            {
                const res = await withAuth(request(app).put("/api/markers/1"))
        ...
        describe("DELETE", () => 
        {
            ...
            {
                const res = await withAuth(request(app).delete("/api/markers/1"))
